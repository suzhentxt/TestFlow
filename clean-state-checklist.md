...
| Baseline PowerShell | Đã chạy | `powershell -NoProfile -ExecutionPolicy Bypass -File ./init.ps1` exit 0; docs-only baseline passed |
| Feature đang xử lý | Hoàn tất | `ops-001` chuyển `passing` sau baseline |
